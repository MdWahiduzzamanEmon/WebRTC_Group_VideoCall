...
class CallingRoom extends Component {
    ...
    connectToSocketServer = () => {
        ...
        socket.on('connect', () => {
            ...
            socket.on('user-left', (id) => {
                ...
                // sessionStorage.setItem("askForUsername", true)
            })
            ...
            socket.on('user-joined', (id, clients) => {
                clients.forEach((socketListId) => {
                    ...
                    socket.on('user-name', this.setUserList)
    ...
    componentDidMount = () => {
        this.handleUsername({ target: { value: localStorage.getItem("username") ? localStorage.getItem("username") : "Guest" } })
        setTimeout(() => {
            this.connect()
        }
            , 1000)
    ...
    setUserList = (userList) => {
        ...
        // object to array 
        let arr = Object.keys(userList).map(function (key) {
            return userList[key];
        }
        );
